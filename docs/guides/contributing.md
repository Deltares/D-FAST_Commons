...
When we are releasing D-FAST_Commons, we want to create a release on GitHub and PyPi.
This should only be done by one of the D-FAST_Commons maintainers.
To prepare for releasing, please make sure you have a clean checkout of the latest `main` branch and follow these steps:

 * Go to the root level your D-FAST_Commons checkout location
...
* Go to the D-FAST_Commons GitHub page.
